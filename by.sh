...
export ZIP_DIR="/workspace/q/anykernel"
export IS_MIUI="no"
export KERNEL_DIR=$(pwd)
export KBUILD_BUILD_USER="RocksCI"
export GCC_COMPILE="yes" 
export KBUILD_BUILD_HOST="wastingmylife"
...
rm -rf $ZIP_DIR && git clone https://github.com/wastingmylife/AnyKernel3 $ZIP_DIR
}
